...
fn test_chmod_regular_conflict() {
    ...
    Working copy  (@) now at: yostqsxw afe56840 conflict | (conflict) conflict
...
fn test_chmod_file_dir_deletion_conflicts() {
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: kmkuslsw 2094ca57 file_deletion | (conflict) file_deletion
    ...
    New conflicts appeared in 1 commits:
      kmkuslsw 2094ca57 file_deletion | (conflict) file_deletion
